// polybook.c
// Polyglot opening-book support: loads performance.bin, builds
// an in-memory array of entries and picks random book moves
// matching the current Polyglot hash key.
