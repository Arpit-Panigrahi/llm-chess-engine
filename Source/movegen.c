// movegen.c
// Core pseudo-legal move generator, including captures-only
// lists, pawn moves (with promotions/EP), castling and move
// scoring for ordering (MVV/LVA, killers, history).
