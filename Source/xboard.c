// xboard.c
// XBoard/WinBoard protocol and text console loop: interprets
// user/GUI commands, handles time controls, detects game end
// conditions and calls SearchPosition for engine moves.
