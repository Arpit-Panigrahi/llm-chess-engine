// makemove.c
// Applies and undoes moves on S_BOARD: updates material, piece
// lists, pawn bitboards, castling, en-passant and Zobrist key,
// and rejects illegal moves that leave own king in check.
